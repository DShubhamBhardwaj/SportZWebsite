...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block " src="img/cricket/dhoni.jpg" alt="Mahendra Singh Dhoni">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=2&teamID=21&name=MS"><div class="text">Mahendra Singh Dhoni</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/cricket/kholi.jpg" alt="Virat Kohli">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=2&teamID=21&name=Virat"><div class="text">Virat Kohli</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/cricket/rohit.jpg" alt="Rohit Sharma">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=2&teamID=21&name=ROhit"><div class="text">Rohit Sharma</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/cricket/pandya.jpg" alt="Hardik Pandya">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=2&teamID=21&name=Hardik"><div class="text">Hardik Pandya</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/cricket/bumrah.jpg" alt="Jasprit Bumrah">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=2&teamID=21&name=Jasprit"><div class="text">Jasprit Bumrah</div></a>
        </div>
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
    ...
    else{ $sql="select Tname,Ranking from team where gameID='2'order by Ranking ";
        $result=$conn->query($sql);
         if($result->num_rows>0){
              while($row = mysqli_fetch_row($result))
              {
                    echo"<tr><td><a href=team.php?username=$username&gameID=2&name=$row[0]>$row[0]<a></td> <td> $row[1] </td></tr>";                }
         }

...
$newpassword=filter_input(INPUT_POST,'uname');
$host="localhost";
    $dbusername="root";
    $dbpassword="";
    $dbname="sports";
         ...
         if($result->num_rows>0){
            $row = mysqli_fetch_row($result);
             ...
             if(!empty($newpassword)){
                 echo"heloo";
                $sql1="UPDATE user SET password ='$newpassword' WHERE  ID='$row[0]'";
                if($conn->query($sql1)){
                    echo'<script>
...
<div class="container-fluid bg">
    <div class="row">
        ...
        <form class="form-container" method="post" action="password.php?username=<?php echo $username?>" > 
            <h1 style="color: #000066">Enter new Password: </h1>

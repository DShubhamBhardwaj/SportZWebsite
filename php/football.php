...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block " src="img/football/m2.jpg" alt="Lionel Mesii">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=3&teamID=56&name=Lionel"><div class="text">Lionel Messi</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/football/ronaldo.jpg" alt="Christiano Ronaldo">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=3&teamID=35&name=Christiano"><div class="text">Christiano Ronaldo</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/football/neymar.jpg" alt="Neymar Junior">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=3&teamID=33&name=Neymar"><div class="text">Neymar Junior</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/football/bale.jpg" alt="Gerath Bale">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=3&teamID=58&name=Gerath"><div class="text">Gerath Bale</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/football/zlatan.jpg" alt="Zlatan Ibhmramovic">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=3&teamID=57&name=Zlatan"><div class="text">Zlatan Ibhmramovic</div></a>
        </div>
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
    ...
    <h1 style="color:black; background-color:grey; opacity:70%">Inetrnational Rankings :</h1>
    <table>
        <th>COUNTRY</th>
        <th>RANK</th>
    <?php
    ...
    else{ $sql="select Tname,Ranking from team where gameID='3'order by Ranking ";
        $result=$conn->query($sql);
         if($result->num_rows>0){
              while($row = mysqli_fetch_row($result))
              {
                    echo"<tr><td><a href=team.php?username=$username&gameID=3&name=$row[0]>$row[0]<a></td> <td> $row[1] </td></tr>";                }
         }

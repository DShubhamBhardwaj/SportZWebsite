...
<head>
    ...
    <style>
        .bg
        {
            background: url(img/hockeybg.jpgv.jpg) no-repeat ;
            height: 100vh;
            width: 100%;
        }
        table{
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block " src="img/hockey/pr.jpg" alt="PR Shreejesh">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=5&teamID=55&name=PR"><div class="text">PR Shreejesh</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/hockey/sandeep.jpg" alt="Sandeep Singh">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=5&teamID=55&name=Sandeep"><div class="text">Sandeep Singh</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/hockey/manpreet.jpg" alt="Manpreet Singh">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=5&teamID=55&name=Manpreet"><div class="text">Manpreet Singh</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/hockey/surendra.jpg" alt="Surendra Kumar">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=5&teamID=55&name=Surendra"><div class="text">Surendra Kumar</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/hockey/akashdeep.jpg" alt="Akashdeep Singh">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=5&teamID=55&name=Akashdeep"><div class="text">Akashdeep Singh</div></a>
        </div>
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
    ...
    else{ $sql="select Tname,Ranking from team where gameID='5'order by Ranking ";
        $result=$conn->query($sql);
         if($result->num_rows>0){
              while($row = mysqli_fetch_row($result))
              {
                    echo"<tr><td><a href=team.php?username=$username&gameID=5&name=$row[0]>$row[0]<a></td> <td> $row[1] </td></tr>";                }
         } 

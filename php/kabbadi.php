...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block " src="img/kabbadi/ajay.jpg" alt="Ajay Thakur">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=4&teamID=41&name=Ajay"><div class="text">Ajay Thakur</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/kabbadi/rahul.jpg" alt="Rahul Chaudhary">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=4&teamID=41&name=Rahul"><div class="text">Rahul Chaudhary</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/kabbadi/anup.jpg" alt="Anup Kumar">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=4&teamID=41&name=Anup"><div class="text">Anup Kumar</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/kabbadi/pradeep.jpg" alt="Pradeep Narwal">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=4&teamID=41&name=Pradeep"><div class="text">Pradeep Narwal</div></a>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block " src="img/kabbadi/rakesh.jpg" alt="Rakesh Kumar">
        <div class="middle">
            <a href="player.php?username=<?php echo $username ?>&gameID=4&teamID=41&name=Rakesh"><div class="text">Rakesh Kumar</div></a>
        </div>
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carousel" role="button" data-slide="next">
    ...
    else{ $sql="select Tname,Ranking from team where gameID='4'order by Ranking ";
        $result=$conn->query($sql);
         if($result->num_rows>0){
              while($row = mysqli_fetch_row($result))
              {
                    echo"<tr><td><a href=team.php?username=$username&gameID=4&name=$row[0]>$row[0]<a></td> <td> $row[1] </td></tr>";                }
         }
